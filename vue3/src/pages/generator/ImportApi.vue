...
export default {
  ...
  data: function () {
    return {
      ...
      apiInfo: {
        apiCode: 'GE30010',
        url: this.getApiUrl('/generator/api/upload'),
        messageCode: 'ZZ40010-I0',
      },
      apiInfoInitialize: {
        apiCode: 'GE30020',
        url: this.getApiUrl('/generator/api/initialize'),
        messageCode: 'ZZ40020-I0',
      },
      apiInfoImport: {
        apiCode: 'GE30030',
        url: this.getApiUrl('/generator/api/import'),
  ...
  methods: {
    uploadExcel: async function (e) {
      ...
      if (this.apiInfo.messageCode !== this.apiResponse.messageCode) {
